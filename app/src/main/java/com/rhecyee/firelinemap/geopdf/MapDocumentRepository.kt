...
class MapDocumentRepository(private val context: Context) {
    ...
    companion object {
        ...
        // Rasterising a sheet is MapSheetRenderer's job, not this class's.
        // There was a whole-page render here, taken at a fixed width: 2048 on
        // the phone and 1536 on the car screen. On the arch E sheets incidents
        // actually publish that is 43 and 32 DPI, so an imported map was
        // unreadable the moment it was zoomed, in the vehicle worst of all.
        // It is gone rather than tuned because no one fixed width can be
        // right: the renderer draws the window being looked at, at the
        // resolution it is being looked at.
